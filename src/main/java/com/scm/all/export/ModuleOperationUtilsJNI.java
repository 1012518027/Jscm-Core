...
//    炫彩界面库  http://8.138.59.98/xcgui/index.html
     ...
     *
     * @param hWindow  窗口句柄
     * @param position 弹出位置 TagPosition：top-顶部，right-右侧等
     * @param pTitle   通知标题
     * @param pText    通知内容
     * @param hIcon    通知图标句柄
     * @param skin     外观类型 TagNotifyMsgSkin
     * @return 返回面板元素句柄
     */
     ...
     * 弹出桌面通知消息（未实现，预留接口）
     *
     * @param position 弹出位置 TagPosition
     * @param pTitle   通知标题
     * @param pText    通知内容
     * @param hIcon    通知图标句柄
     * @param skin     外观类型 TagNotifyMsgSkin
     ...
     * RC资源查找文件从ID
     *
     * @param id 源ID(整数), 如果资源类型为字符串, 请使用RC资源文件名RC资源文件名的ID(101, 数据大小, NULL, PNG)
     * @param outSize 返回资源大小(字节为单位)
     * @param hModule RC资源所属模块, 如果指定NULL, 那么为当前EXE模块
     * @param type    资源类型, 在RC资源中指定的类型名称, 一般普通文件"RT_RCDATA"
     * @return 文件句柄
     ...
     * RC资源查找文件从ID
     *
     * @param id 资源ID(整数), 如果资源类型为字符串, 请使用RC资源文件名RC资源文件名的ID(101, 数据大小, NULL, PNG)
     * @param outSize 返回资源大小(字节为单位)
     * @param hModule RC资源所属模块, 如果指定NULL, 那么为当前EXE模块
     * @param type    资源类型, 在RC资源中指定的类型名称, 一般普通文件"RT_RCDATA"
     * @return 文件句柄
...
// 共转换 2322 个方法
     ...
     * @return 返回整数
     */
    public static native int report_Fields_GetItemString(String value);
     ...
     * 读计算标签文本高度
     *
     * @param textString 字符串参数
     * @return 返回小数
     */
    public static native float report_Graphics_GetCalcLabelTextHeight(String textString);
     ...
     * @return 返回小数
     */
    public static native float report_Graphics_GetCalcLabelTextWidth(String textString);
     ...
     * @return 返回整数
     */
    public static native int report_Graphics_GetCalcTextOutLen(float width, float height, String textString, boolean autoWrap);
     ...
     * @return 返回小数
     */
    public static native float report_Graphics_GetCalcDrawFormatTextWidth(String Text, int value);
     ...
     * @return 返回小数
     */
    public static native float report_Graphics_GetCalcDrawFormatTextHeight(String textString, float width, int textFormatObject);
     ...
     * @return 返回整数
     */
    public static native int report_Graphics_GetCalcDrawFormatTextOutLen(String textString, float width, float height, int textFormatObject);
     ...
     * @param top        小数参数
     */
    public static native void report_Graphics_DrawLabelText(String textString, float left, float top);
     ...
     * @param angle      小数参数
     */
    public static native void report_Graphics_DrawRotateText(String textString, float left, float top, float angle);
     ...
     * @param value2     布尔参数
     */
    public static native void report_Graphics_DrawText(String textString, float left, float top, float width, float height, int value, boolean value2);
     ...
     * @param textFormatObject 整数参数
     */
    public static native void report_Graphics_DrawFormatText(String textString, float left, float top, float width, float height, int textFormatObject);
     ...
     * @param textFormatObject 整数参数
     */
    public static native void report_Graphics_DrawFormatTextShrinkToFit(String textString, float left, float top, float width, float height, int textFormatObject);
     ...
     * @return 返回整数
     */
    public static native int report_Groups_GetItemString(String value);
     ...
     * @return 返回整数
     */
    public static native int report_Groups_GetItemByName(String Name);
     ...
     * @return 返回整数
     */
    public static native int report_Groups_GetItemAt(String Index);
     ...
     * @return 返回整数
     */
    public static native int report_Parameters_GetItemString(String value);
     ...
     * @return 返回整数
     */
    public static native int report_ReportHeaders_GetItemString(String value);
     ...
     * @return 返回布尔值
     */
    public static native boolean report_Table_BindEvent(CGridppReportEventHandler value);
     ...
     * @return 返回整数
     */
    public static native long report_Barcode_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Barcode_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Barcode_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_BinaryObject_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_BinaryObject_InitPointer_();
     ...
     * @return 返回布尔值
     */
    public static native boolean report_BinaryObject_LoadFromField_(long value);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_BinaryObject_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Border_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Border_GetInnerPen_();
     ...
     * @return 返回整数
     */
    public static native long report_Border_GetPen_();
     ...
     * @return 返回整数
     */
    public static native long report_Border_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Border_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_CellBase_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_CellBase_GetBorder_();
     ...
     * @return 返回整数
     */
    public static native long report_CellBase_GetControls_();
     ...
     * @return 返回整数
     */
    public static native long report_CellBase_GetFont_();
     ...
     * @return 返回整数
     */
    public static native long report_CellBase_GetTextFormat_();
     ...
     * @return 返回整数
     */
    public static native long report_CellBase_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_CellBase_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ChartAxis_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ChartAxis_GetCoordLinePen_();
     ...
     * @return 返回整数
     */
    public static native long report_ChartAxis_GetLinePen_();
     ...
     * @return 返回整数
     */
    public static native long report_ChartAxis_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ChartAxis_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeriesCollection_Add_();
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeriesCollection_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeriesCollection_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeriesCollection_GetItemBy_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeriesCollection_GetItemString_(String value);
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeriesCollection_GetItemVariant_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeriesCollection_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeriesCollection_ItemAt_(int Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ChartSeriesCollection_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeries_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeries_GetBorderPen_();
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeries_GetMarkerPen_();
     ...
     * @return 返回整数
     */
    public static native long report_ChartSeries_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ChartSeries_SetComPointer_(long COM_ID);
     ...
     * @param value 整数参数
     */
    public static native void report_ChartSeries_SetObject_(long value);
     ...
     * @return 返回整数
     */
    public static native long report_Chart_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Chart_GetRecordset_();
     ...
     * @return 返回整数
     */
    public static native long report_Chart_GetSeries_();
     ...
     * @return 返回整数
     */
    public static native long report_Chart_GetTitleFont_();
     ...
     * @return 返回整数
     */
    public static native long report_Chart_GetValueFont_();
     ...
     * @return 返回整数
     */
    public static native long report_Chart_GetXAxis_();
     ...
     * @return 返回整数
     */
    public static native long report_Chart_GetY2Axis_();
     ...
     * @return 返回整数
     */
    public static native long report_Chart_GetYAxis_();
     ...
     * @return 返回整数
     */
    public static native long report_Chart_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Chart_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnCell_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnCell_GetColumn_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnCell_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCel_GetParent_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCell_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCell_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ColumnContentCell_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCells_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCells_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCells_GetItemBy_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCells_GetItemString_(String NamePointer);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCells_GetItemVariant_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCells_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContentCells_ItemAt_(int Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ColumnContentCells_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContent_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContent_GetContentCells_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnContent_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ColumnContent_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnSection_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnSection_GetDetailGrid_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnSection_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ColumnSection_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCell_AddSubGroupTitle_(String name, String Caption);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCell_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCell_GetParent_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCell_GetSubTitles_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCell_GetSupCell_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCell_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ColumnTitleCell_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCells_AddGroup_(String Name, String Title);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCells_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCells_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCells_GetItemBy_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCells_GetItemString_(String NamePointer);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCells_GetItemVariant_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCells_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitleCells_ItemAt_(int Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ColumnTitleCells_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitle_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitle_GetTitleCells_();
     ...
     * @return 返回整数
     */
    public static native long report_ColumnTitle_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_Column_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Column_GetContentCell_();
     ...
     * @return 返回整数
     */
    public static native long report_Column_GetParent_();
     ...
     * @return 返回整数
     */
    public static native long report_Column_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Column_SetComPointer_(long COM_ID);
     ...
     * @param addressCOM 整数参数
     */
    public static native void report_Column_SetContentCell_(long addressCOM);
     ...
     * @param addressCOM 整数参数
     */
    public static native void report_Column_SetParent_(long addressCOM);
     ...
     * @return 返回整数
     */
    public static native long report_Columns_Add_();
     ...
     * @return 返回整数
     */
    public static native long report_Columns_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Columns_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_Columns_GetItemBy_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_Columns_GetItemString_(String NamePointer);
     ...
     * @return 返回整数
     */
    public static native long report_Columns_GetItemVariant_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_Columns_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_Columns_ItemAt_(int Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Columns_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Control_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsBarcode_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsChart_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsFieldBox_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsFreeGrid_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsLine_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsMemoBox_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsPictureBox_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsRichTextBox_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsShapeBox_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsStaticBox_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsSubReport_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsSummaryBox_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsSystemVarBox_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetAsTextBox_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetBorder_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetFont_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_GetParent_();
     ...
     * @return 返回整数
     */
    public static native long report_Control_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_Controls_Add_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_Controls_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Controls_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_Controls_GetItemBy_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_Controls_GetItemInt_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_Controls_GetItemString_(String value);
     ...
     * @return 返回整数
     */
    public static native long report_Controls_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_Controls_ItemAt_(int Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Controls_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_CrossTab_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_CrossTab_GetRecordset_();
     ...
     * @return 返回整数
     */
    public static native long report_CrossTab_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_CrossTab_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_DateTime_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_DateTime_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_DateTime_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_AddColumn_(String Name, String TitleText, String CloseField, float ColumnWidth);
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_AddGroupTitle_(String Name, String TitleText);
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_ColumnByShowOrder_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_FindGroupTitleCell_(String TitleName);
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_GetBorder_();
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_GetColLinePen_();
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_GetColumnContent_();
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_GetColumns_();
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_GetCrossTab_();
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_GetFont_();
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_GetGroups_();
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_GetRecordset_();
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_GetRowLinePen_();
     ...
     * @return 返回整数
     */
    public static native long report_DetailGrid_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_DetailGrid_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_E2CSVOption_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_E2CSVOption_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_E2CellOption_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_E2CellOption_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_E2HTMOption_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_E2IMGOption_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_E2IMGOption_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_E2PDFOption_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_E2PDFOption_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_E2RTFOption_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_E2RTFOption_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_E2TXTOption_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_E2TXTOption_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_E2XLSOption_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_E2XLSOption_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ExportOption_GetAsE2CSVOption_();
     ...
     * @return 返回整数
     */
    public static native long report_ExportOption_GetAsE2CellOption_();
     ...
     * @return 返回整数
     */
    public static native long report_ExportOption_GetAsE2HTMOption_();
     ...
     * @return 返回整数
     */
    public static native long report_ExportOption_GetAsE2IMGOption_();
     ...
     * @return 返回整数
     */
    public static native long report_ExportOption_GetAsE2PDFOption_();
     ...
     * @return 返回整数
     */
    public static native long report_ExportOption_GetAsE2RTFOption_();
     ...
     * @return 返回整数
     */
    public static native long report_ExportOption_GetAsE2TXTOption_();
     ...
     * @return 返回整数
     */
    public static native long report_ExportOption_GetAsE2XLSOption_();
     ...
     * @return 返回整数
     */
    public static native long report_ExportOption_InitPointer_();
     ...
     * @return 返回布尔值
     */
    public static native boolean report_ExportOption_SetCOMObject_(long addressCOM);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ExportOption_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_FieldBox_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_FieldBox_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_FieldBox_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Field_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Field_InitPointer_();
     ...
     * @param value 整数参数
     */
    public static native void report_Field_LoadFromBinary_(long value);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Field_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Fields_Add_();
     ...
     * @return 返回整数
     */
    public static native long report_Fields_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Fields_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_Fields_GetItemBy_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_Fields_GetItemInt_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_Fields_GetItemString_(String value);
     ...
     * @return 返回整数
     */
    public static native long report_Fields_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_Fields_ItemAt_(int Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Fields_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Font_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Font_Clone_();
     ...
     * @return 返回整数
     */
    public static native long report_Font_GetOleFont_();
     ...
     * @return 返回整数
     */
    public static native long report_Font_GetUsingOleFont_();
     ...
     * @return 返回整数
     */
    public static native long report_Font_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Font_SetComPointer_(long COM_ID);
     ...
     * @param value 整数参数
     */
    public static native void report_Font_SetOleFont_(long value);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGridCell_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGridCell_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_FreeGridCell_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGridColumn_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGridColumn_GetFreeGrid_();
     ...
     * @return 返回整数
     */
    public static native long report_FreeGridColumn_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_FreeGridColumn_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGridRow_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGridRow_GetFreeGrid_();
     ...
     * @return 返回整数
     */
    public static native long report_FreeGridRow_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_FreeGridRow_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGrid_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGrid_CellAt_(int RowNumber, int ColumnNumber);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGrid_CellByDataName_(String DataName);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGrid_ColumnAt_(int ColumnNumber);
     ...
     * @return 返回整数
     */
    public static native long report_FreeGrid_GetColLinePen_();
     ...
     * @return 返回整数
     */
    public static native long report_FreeGrid_GetRowLinePen_();
     ...
     * @return 返回整数
     */
    public static native long report_FreeGrid_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_FreeGrid_RowAt_(long RowNumber);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_FreeGrid_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Graphics_Assign_(long ID);
     ...
     * @param textFormatObject 整数参数
     */
    public static native void report_Graphics_DrawFormatTextShrinkToFit_(String textString, float left, float top, float width, float height, int textFormatObject);
     ...
     * @param textFormatObject 整数参数
     */
    public static native void report_Graphics_DrawFormatText_(String textString, float left, float top, float width, float height, int textFormatObject);
     ...
     * @param value3              整数参数
     */
    public static native void report_Graphics_DrawPicture_(long reportPictureObject, float left, float top, float width, float height, long value, long value2, int value3);
     ...
     * @return 返回小数
     */
    public static native float report_Graphics_GetCalcDrawFormatTextHeight_(String textString, float width, int textFormatObject);
     ...
     * @return 返回整数
     */
    public static native long report_Graphics_GetCalcDrawFormatTextOutLen_(String textString, float width, float height, int textFormatObject);
     ...
     * @return 返回小数
     */
    public static native float report_Graphics_GetCalcDrawFormatTextWidth_(String Text, long value);
     ...
     * @return 返回整数
     */
    public static native long report_Graphics_InitPointer_();
     ...
     * @param fontObject 整数参数
     */
    public static native void report_Graphics_SelectFont_(long fontObject);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Graphics_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_GroupFooter_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_GroupFooter_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_GroupFooter_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_GroupHeader_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_GroupHeader_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_GroupHeader_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_GroupSection_Assign_(long ID1);
     ...
     * @return 返回整数
     */
    public static native long report_GroupSection_GetGroup_();
     ...
     * @return 返回整数
     */
    public static native long report_GroupSection_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_GroupSection_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Group_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Group_GetFooter_();
     ...
     * @return 返回整数
     */
    public static native long report_Group_GetHeader_();
     ...
     * @return 返回整数
     */
    public static native long report_Group_GetParent_();
     ...
     * @return 返回整数
     */
    public static native long report_Group_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Group_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Groups_Add_();
     ...
     * @return 返回整数
     */
    public static native long report_Groups_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Groups_GetItemAt_(String Index);
     ...
     * @return 返回整数
     */
    public static native long report_Groups_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_Groups_GetItemBy_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_Groups_GetItemInt_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_Groups_GetItemString_(String value);
     ...
     * @return 返回整数
     */
    public static native long report_Groups_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_IGRSharePrintSetupObject_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_IGRSharePrintSetupObject_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_IGRSharePrintSetupObject_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native int report_ImageList_AddFromBinary_(long Binary);
     ...
     * @return 返回整数
     */
    public static native long report_ImageList_Add_(long Image);
     ...
     * @return 返回整数
     */
    public static native long report_ImageList_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ImageList_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_ImageList_Item_(long Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ImageList_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Line_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Line_GetLinePen_();
     ...
     * @return 返回整数
     */
    public static native long report_Line_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Line_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_MemoBox_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_MemoBox_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_MemoBox_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Object_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Object_GetCOMObject_();
     ...
     * @return 返回整数
     */
    public static native long report_Object_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Object_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Parameter_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Parameter_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Parameter_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Parameters_Add_();
     ...
     * @return 返回整数
     */
    public static native long report_Parameters_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Parameters_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_Parameters_GetItemBy_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_Parameters_GetItemInt_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_Parameters_GetItemString_(String value);
     ...
     * @return 返回整数
     */
    public static native long report_Parameters_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_Parameters_ItemAt_(int Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Parameters_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Pen_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Pen_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Pen_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_PictureBox_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_PictureBox_GetPicture_();
     ...
     * @return 返回整数
     */
    public static native long report_PictureBox_InitPointer_();
     ...
     * @param value 整数参数
     */
    public static native void report_PictureBox_LoadBmpPictureCOM_(long value);
     ...
     * @param value 整数参数
     */
    public static native void report_PictureBox_LoadBmpPicture_(long value);
     ...
     * @param value 整数参数
     */
    public static native void report_PictureBox_LoadFromBinary_(long value);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_PictureBox_SetComPointer_(long COM_ID);
     ...
     * @param value 整数参数
     */
    public static native void report_PictureBox_SetPicture_(long value);
     ...
     * @return 返回整数
     */
    public static native long report_Picture_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Picture_GetOlePicture_();
     ...
     * @return 返回整数
     */
    public static native long report_Picture_InitPointer_();
     ...
     * @return 返回布尔值
     */
    public static native boolean report_Picture_LoadFromBinary_(long value);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Picture_SetComPointer_(long COM_ID);
     ...
     * @param value 整数参数
     */
    public static native void report_Picture_SetOlePicture_(long value);
     ...
     * @return 返回整数
     */
    public static native long report_Printer_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Printer_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Printer_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Recordset_AddField_(String FieldName, int value);
     ...
     * @return 返回整数
     */
    public static native long report_Recordset_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Recordset_FieldByDBName_(String value);
     ...
     * @return 返回整数
     */
    public static native long report_Recordset_FieldByName_(String value);
     ...
     * @return 返回整数
     */
    public static native long report_Recordset_GetFields_();
     ...
     * @return 返回整数
     */
    public static native long report_Recordset_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Recordset_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooter_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooter_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ReportFooter_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooters_Add_();
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooters_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooters_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooters_GetItemBy_(long Index);
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooters_GetItemInt_(long value);
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooters_GetItemString_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooters_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_ReportFooters_ItemAt_(int Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ReportFooters_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ReportHeaders_Add_();
     ...
     * @return 返回整数
     */
    public static native long report_ReportHeaders_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ReportHeaders_GetItemByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_ReportHeaders_GetItemBy_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_ReportHeaders_GetItemInt_(int value);
     ...
     * @return 返回整数
     */
    public static native long report_ReportHeaders_GetItemString_(String value);
     ...
     * @return 返回整数
     */
    public static native long report_ReportHeaders_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_ReportHeaders_ItemAt_(long Index);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ReportHeaders_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ReportSection_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ReportSection_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ReportSection_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_RichTextBox_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_RichTextBox_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_RichTextBox_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Section_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Section_GetControls_();
     ...
     * @return 返回整数
     */
    public static native long report_Section_GetFont_();
     ...
     * @return 返回整数
     */
    public static native long report_Section_GetParent_();
     ...
     * @return 返回整数
     */
    public static native long report_Section_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Section_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_ShapeBox_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_ShapeBox_GetLinePen_();
     ...
     * @return 返回整数
     */
    public static native long report_ShapeBox_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_ShapeBox_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_StaticBox_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_StaticBox_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_StaticBox_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_SubReport_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_SubReport_GetReport_();
     ...
     * @return 返回整数
     */
    public static native long report_SubReport_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_SubReport_SetComPointer_(long COM_ID);
     ...
     * @param value 整数参数
     */
    public static native void report_SubReport_SetReport_(long value);
     ...
     * @return 返回整数
     */
    public static native long report_SummaryBox_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_SummaryBox_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_SummaryBox_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_SystemVarBox_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_SystemVarBox_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_SystemVarBox_SetComPointer_(long COM_ID);
     ...
     * @return 返回布尔值
     */
    public static native boolean report_TableDesignShow_BindEvent_(CGRDesignerEventHandler value);
     ...
     * @return 返回整数
     */
    public static native long report_TableDesignShow_CreateSelectShowWindow_(int value, int value2, int cx, int cy, int hWindow);
     ...
     * @return 返回整数
     */
    public static native long report_TableDesignShow_GetDisplayViewer_();
     ...
     * @return 返回整数
     */
    public static native long report_TableDesignShow_GetPrintViewer_();
     ...
     * @return 返回整数
     */
    public static native long report_TableDesignShow_GetReport_();
     ...
     * @return 返回整数
     */
    public static native long report_TableDesignShow_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_TableDesignShow_SetComPointer_(long COM_ID);
     ...
     * @param Report 整数参数
     */
    public static native void report_TableDesignShow_SetReport_(long Report);
     ...
     * @return 返回布尔值
     */
    public static native boolean report_TablePrintShow_BindEvent_(CGRPrintViewerEventHandler value);
     ...
     * @return 返回整数
     */
    public static native long report_TablePrintShow_CreateSelectShowWindow_(int value, int value2, int cx, int cy, int hWindow);
     ...
     * @return 返回整数
     */
    public static native long report_TablePrintShow_GetReport_();
     ...
     * @param COMObject 整数参数
     */
    public static native void report_TablePrintShow_SetCOMObject_(long COMObject);
     ...
     * @param Report 整数参数
     */
    public static native void report_TablePrintShow_SetReport_(long Report);
     ...
     * @return 返回布尔值
     */
    public static native boolean report_TableSelectShow_BindEvent_(CGRDisplayViewerEventHandler value);
     ...
     * @return 返回整数
     */
    public static native long report_TableSelectShow_CreateSelectShowWindow_(int value, int value2, int cx, int cy, int hWindow);
     ...
     * @return 返回整数
     */
    public static native long report_TableSelectShow_GetContentCellFromPos_(int value, int value2);
     ...
     * @return 返回整数
     */
    public static native long report_TableSelectShow_GetControlFromPos_(int value, int value2);
     ...
     * @return 返回整数
     */
    public static native long report_TableSelectShow_GetReport_();
     ...
     * @return 返回整数
     */
    public static native long report_TableSelectShow_GetSectionFromPos_(int value, int value2);
     ...
     * @return 返回整数
     */
    public static native long report_TableSelectShow_GetTitleCellFromPos_(int value, int value2);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_TableSelectShow_SetComPointer_(long COM_ID);
     ...
     * @param value 整数参数
     */
    public static native void report_TableSelectShow_SetObject_(long value);
     ...
     * @param value 整数参数
     */
    public static native void report_TableSelectShow_SetReport_(long value);
     ...
     * @param ObjectPointer 整数参数
     */
    public static native void report_TableSelectShow_UpdateControl_(long ObjectPointer);
     ...
     * @return 返回整数
     */
    public static native long report_Table_AddParameter_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_Assign_(long ID);

    /**
     * 绑定事件
     *
     * @param value CGridppReportEventHandler参数
     * @return 返回布尔值
     */
    public static native boolean report_Table_BindEvent_(CGridppReportEventHandler value);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ColumnByName_(String ColumnName);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ControlByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_Table_FieldByDBName_(String FieldName);
     ...
     * @return 返回整数
     */
    public static native long report_Table_FieldByName_(String FieldName);
     ...
     * @return 返回整数
     */
    public static native long report_Table_FindFirstControl_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_FindNextControl_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GenerateDocumentData_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetBackImage_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetDetailGrid_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetFiringReport_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetFloatControls_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetFont_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetGraphics_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetImageList_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetPageFooter_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetPageHeader_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetParameters_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetParentReport_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetPrinter_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetReportFooters_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetReportHeaders_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetRunningDetailGrid_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetSharePrintSetupObject_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetUtility_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_GetWatermark_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_InitPointer_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_Init_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_InsertDetailGrid_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_InsertPageFooter_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_InsertPageHeader_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_InsertReportFooter_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_InsertReportHeader_();
     ...
     * @return 返回整数
     */
    public static native long report_Table_ParameterByName_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_Table_PrepareExport_(long value);
     ...
     * @return 返回布尔值
     */
    public static native boolean report_Table_PrintDocumentData_(long BinaryObject);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ReportFooterInt1_(int NameIndex);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ReportFooterInt_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ReportFooterString1_(String NameIndex);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ReportFooterString_(String Name);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ReportHeaderInt1_(int Index);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ReportHeaderInt_(int NameIndex);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ReportHeaderString1_(String NameIndex);
     ...
     * @return 返回整数
     */
    public static native long report_Table_ReportHeaderString_(String Name);
     ...
     * @param BackImage 整数参数
     */
    public static native void report_Table_SetBackImage_(long BackImage);
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Table_SetComPointer_(long COM_ID);
     ...
     * @param Watermark 整数参数
     */
    public static native void report_Table_SetWatermark_(long Watermark);
     ...
     * @return 返回整数
     */
    public static native long report_TextBox_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_TextBox_GetTextFormat_();
     ...
     * @return 返回整数
     */
    public static native long report_TextBox_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_TextBox_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_TextFormat_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_TextFormat_Clone_();
     ...
     * @return 返回整数
     */
    public static native long report_TextFormat_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_TextFormat_SetComPointer_(long COM_ID);
     ...
     * @return 返回整数
     */
    public static native long report_Utility_Assign_(long ID);
     ...
     * @return 返回整数
     */
    public static native long report_Utility_CreateBinaryObject_();
     ...
     * @return 返回整数
     */
    public static native long report_Utility_CreateDateTime_();
     ...
     * @return 返回整数
     */
    public static native long report_Utility_CreatePicture_();
     ...
     * @return 返回整数
     */
    public static native long report_Utility_CreateRecordset_();
     ...
     * @return 返回整数
     */
    public static native long report_Utility_CreateTextFormat_();
     ...
     * @return 返回整数
     */
    public static native int report_Utility_FormatTextHeight_(String textString, int width, long textFormatObject, long reportFontObject);
     ...
     * @return 返回整数
     */
    public static native int report_Utility_FormatTextOutLen_(String textString, int width, int height, long textFormatObject, long reportFontObject);
     ...
     * @return 返回整数
     */
    public static native int report_Utility_FormatTextWidth_(String textString, long textFormatObject, long reportFontObject);
     ...
     * @return 返回整数
     */
    public static native long report_Utility_InitPointer_();
     ...
     * @param COM_ID 整数参数
     */
    public static native void report_Utility_SetComPointer_(long COM_ID);
     ...
     * 增加引用
     *
     * @param id2D1Factory 对象指针
     * @return 返回对象COM指针
     */
    public static native long XDraw_ID2D1Factory_AddRef(int id2D1Factory);
     ...
     * @param dpiX          屏幕分辨率
     * @param dpiY          屏幕分辨率
     * @param minLevel_     最小支持的渲染级别
     * @param alpha_mode_   颜色模式
     * @param dxgi_format_  颜色格式
     * @param target_type_  渲染目标类型
     * @param target_usage_ 渲染目标用途
     * @return 返回对象COM指针
     */
    public static native long XDraw_1ID2D1Factory_1CreateDCRenderTarget(int id2D1Factory, float dpiX, float dpiY, int minLevel_, int alpha_mode_, int dxgi_format_, int target_type_, int target_usage_);
