...
public class InstallDDDriver {
    ...
    public static boolean installDriver(){
        if(systemIs64()){
            return ModuleOperationUtilsJNI.Install_DD_VIP(tileDir(),"snailcatmall_x64");
        }else {
            return ModuleOperationUtilsJNI.Install_DD_VIP(tileDir(),"snailcatmall_x86");
        }
    }
    ...
    public static void uninstallDriver(){
        ModuleOperationUtilsJNI.UnInstall_DD_VIP(tileDir());
    }
    ...
    public static void driverHandle(){
        if(systemIs64()){
            ModuleOperationUtilsJNI.Load_DD_Address(tileDir(),-64);
        }else {
            ModuleOperationUtilsJNI.Load_DD_Address(tileDir(),-86);
        }
    }
    ...
    public static int initDriver(){
        if(systemIs64()){
            return ModuleOperationUtilsJNI.Init_DD(-64);
        }else {
            return ModuleOperationUtilsJNI.Init_DD(-86);
        }
    }
