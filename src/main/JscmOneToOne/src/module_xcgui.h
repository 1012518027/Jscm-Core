...
#define SW_HIDE             0   // 窗口显示标识_隐藏
#define SW_SHOWNORMAL       1   // 窗口显示标识_显示并激活还原
#define SW_SHOWMINIMIZED    2	// 窗口显示标识_显示并最小化
#define SW_SHOWMAXIMIZED    3	// 窗口显示标识_显示并最大化
#define SW_SHOWNOACTIVATE   4	// 窗口显示标识_显示不激活
#define SW_SHOW             5	// 窗口显示标识_显示
#define SW_MINIMIZE         6	// 窗口显示标识_最小化
#define SW_SHOWMINNOACTIVE  7	// 窗口显示标识_最小化不激活
#define SW_SHOWNA           8	// 窗口显示标识_显示不激活2
#define SW_RESTORE          9	// 窗口显示标识_还原
#define SW_SHOWDEFAULT      10	// 窗口显示标识_启动初始值
#define SW_FORCEMINIMIZE    11	// 窗口显示标识_强制最小化
...
//对象类型决定功能
//对象样式决定外观
/// group_type_style_  对象类型及样式
/// @{

/// group_ObjectType 对象句柄类型(XC_OBJECT_TYPE)
/// @{
...
/// group_ObjectTypeEx   对象扩展类型(XC_OBJECT_TYPE_EX,功能扩展)
/// @{
enum XC_OBJECT_TYPE_EX  //  炫彩对象扩展类型
{
	xc_ex_error = -1,        ///<错误类型
	// 按钮类型_默认
...
#define  XWM_FLOAT_PANE               0x7000+18  // 窗口事件_浮动窗格  //浮动窗格, 窗格从框架窗口中弹出,变成浮动窗格
...
/// group_position 位置标识(element_position_)
/// @{
enum position_flag_  //  位置标识
{
	//  左
...
//透明窗口
/// groupWindowTransparent 窗口透明标识(window_transparent_)
/// @{
enum  window_transparent_  //  窗口透明标识
{
	//  不透明
...
///@{
enum  menu_popup_position_  //  菜单弹出方向
{
	//  左上角
...
/// groupImageDrawType 图片绘制类型(image_draw_type_)
/// @{
enum  image_draw_type_  //  图片绘制类型
{
	//  默认
...
//状态--------------------------------------
/// groupCommonState3 普通三种状态(common_state3_)
/// @{
enum  common_state3_   //  普通三种状态
{
	//  离开
...
/// groupButtonState 按钮状态(button_state_)
/// @{
enum  button_state_  //  按钮状态
{
	//  离开
...
///   groupComboBoxState 组合框状态(comboBox_state_)
/// @{
enum  comboBox_state_ //  组合框状态
{
	//  鼠标离开
...
/// groupTreeItemState  列表树项状态(tree_item_state_)
/// @{
enum  tree_item_state_  //  列表树项状态
{
	//  鼠标离开
...
/// @{
enum  button_icon_align_  //  按钮图标对齐方式
{
	//  左边
...
/// @{
enum  list_drawItemBk_flag_  //  项背景绘制标识
{
	//  不绘制
...
///@{
enum  propertyGrid_item_type_  //  属性网格项类型
{
	//  文本
...
/// groupLayoutSize 布局大小类型(layout_size_)
/// @{
enum  layout_size_ //  布局大小类型
{
	//  固定
...
///@{
enum edit_textAlign_flag_ //  编辑框文本对齐
{
	//  左侧
...
///Group_textFormatFlag_dwrite_    D2D文本渲染模式(XC_DWRITE_RENDERING_MODE)
///@{
enum XC_DWRITE_RENDERING_MODE  // D2D文本渲染模式
{
	//  默认
...
///@{
enum listItemTemp_type_  // 列表项模板类型
{
	// 列表树
...
/// group_table  形状表格标识(table_flag_)
/// @{

///@name  形状表格标识(table_flag_)
///@{
enum  table_flag_  //  形状表格标识
{
	//  正常
...
/// @{
enum monthCal_button_type_  // 月历卡片按钮类型
{
	//  今天
...
///@{
enum  adapter_date_type_  //  数据适配器数据类型
{
	//  错误
...
///  group_notifyMsg_skin_  通知消息外观(notifyMsg_skin_)
///@{
enum  notifyMsg_skin_  // 通知消息外观
{
	//  默认
...
enum frameWnd_cell_type_  //  框架窗口单元格类型
{
	//  无
...
/// group_combo_StateFlag  组合状态
/// @{

///group_window_state_flag_  窗口状态(window_state_flag_)
///@{
enum  window_state_flag_  //  窗口状态
{
	//  无
...
///@{
enum  button_state_flag_  //  按钮状态标识
{
	//  鼠标离开
...
///@{
enum comboBox_state_flag_   //   组合框状态标识
{
	//  鼠标离开
...
///@{
enum listBox_state_flag_  //  列表框状态
{
	//  项鼠标离开
...
///@{
enum listHeader_state_flag_  //  列表头状态
{
	//  项鼠标离开
...
///@{
enum listView_state_flag_  //  列表视图状态
{
	//  项鼠标离开
...
///@{
enum monthCal_state_flag_     //  月历卡片状态
{
	//  鼠标离开
...
///@{
enum propertyGrid_state_flag_      //   属性网格状态
{
	//  项鼠标离开
