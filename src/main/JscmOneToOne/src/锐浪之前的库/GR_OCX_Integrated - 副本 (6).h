...
// ========================================
HRESULT EmbedGRDisplayViewerOCX(HWND hWndParent, RECT rcPos, UnknownObject& outUnkObject) {
    if (!hWndParent) return E_INVALIDARG;
...
// ========================================
HRESULT EmbedGRPrintViewerOCX(HWND hWndParent, RECT rcPos, UnknownObject& outUnkObject) {
    if (!hWndParent) return E_INVALIDARG;
...
// ========================================
HRESULT EmbedGRDesignerOCX(HWND hWndParent, RECT rcPos, UnknownObject& outUnkObject) {
    if (!hWndParent) return E_INVALIDARG;
