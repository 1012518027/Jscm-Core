...
echo ==========================================
echo    Grid++Report Cleanup - X64 (64-bit)
echo ==========================================
echo.
...
echo [Step 1] Unregister X64 DLLs...
echo.

regsvr32 /u /s "%SystemRoot%\System32\gregn6x64.dll" 2>nul
regsvr32 /u /s "gregn6x64.dll" 2>nul
regsvr32 /u /s ".\gregn6x64.dll" 2>nul
regsvr32 /u /s "%SystemRoot%\System32\grdes6x64.dll" 2>nul
regsvr32 /u /s "grdes6x64.dll" 2>nul
regsvr32 /u /s ".\grdes6x64.dll" 2>nul
regsvr32 /u /s "%SystemRoot%\SysWOW64\gregn6.dll" 2>nul
regsvr32 /u /s "%SystemRoot%\SysWOW64\grdes6.dll" 2>nul
...
del /f /q "%SystemRoot%\System32\gregn6x64.dll" 2>nul
del /f /q "%SystemRoot%\System32\grdes6x64.dll" 2>nul
del /f /q "%SystemRoot%\SysWOW64\gregn6.dll" 2>nul
del /f /q "%SystemRoot%\SysWOW64\grdes6.dll" 2>nul
::del /f /q "gregn6x64.dll" 2>nul
::del /f /q "grdes6x64.dll" 2>nul

echo.
echo ==========================================
echo    Cleanup X64 Complete!
echo ==========================================
pause
